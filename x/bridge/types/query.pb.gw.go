...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RegisteredBtcDepositAddresses_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "registered_btc_deposit_addresses"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RegisteredReserveAddresses_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "registered_reserve_addresses"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RegisteredBtcDepositAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"twilight-project", "nyks", "bridge", "registered_btc_deposit_address", "depositAddress"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RegisteredBtcDepositAddressByTwilightAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"twilight-project", "nyks", "bridge", "registered_btc_deposit_address_by_twilight_address", "twilightDepositAddress"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RegisteredJudges_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "registered_judges"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RegisteredJudgeAddressByValidatorAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"twilight-project", "nyks", "bridge", "registered_judge_address_by_validator_address", "validatorAddress"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_WithdrawBtcRequestAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "withdraw_btc_request_all"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ProposeSweepAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"twilight-project", "nyks", "bridge", "propose_sweep_address", "reserveId", "roundId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ProposeSweepAddressesAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"twilight-project", "nyks", "bridge", "propose_sweep_addresses_all", "limit"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_UnsignedTxSweep_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"twilight-project", "nyks", "bridge", "unsigned_tx_sweep", "reserveId", "roundId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_UnsignedTxSweepAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "unsigned_tx_sweep_all"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_UnsignedTxRefund_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"twilight-project", "nyks", "bridge", "unsigned_tx_refund", "reserveId", "roundId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_UnsignedTxRefundAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "unsigned_tx_refund_all"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SignRefund_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"twilight-project", "nyks", "bridge", "sign_refund", "reserveId", "roundId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SignRefundAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "sign_refund_all"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SignSweep_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"twilight-project", "nyks", "bridge", "sign_sweep", "reserveId", "roundId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SignSweepAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "sign_sweep_all"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BroadcastTxSweep_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"twilight-project", "nyks", "bridge", "broadcast_tx_sweep", "reserveId", "roundId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BroadcastTxSweepAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "broadcast_tx_sweep_all"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BroadcastTxRefund_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"twilight-project", "nyks", "bridge", "broadcast_tx_refund", "reserveId", "roundId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BroadcastTxRefundAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "broadcast_tx_refund_all"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ProposeRefundHashAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"twilight-project", "nyks", "bridge", "propose_refund_hash_all"}, "", runtime.AssumeColonVerbOpt(false)))
)
