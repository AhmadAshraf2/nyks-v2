	...
	return &autocliv1.ModuleOptions{
		Query: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				{
					RpcMethod: "GetAttestations",
					Use:       "get-attestations",
					Short:     "Get attestations with optional filters",
				},
				{
				...
				{
					RpcMethod: "DelegateKeysAll",
					Use:       "delegate-keys-all",
					Short:     "Query all delegate keys",
				},
			},
		},
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				},
				{
					...
					Short:          "Send a SetDelegateAddresses tx",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "validatorAddress"}, {ProtoField: "btcOracleAddress"}, {ProtoField: "btcPublicKey"}, {ProtoField: "zkOracleAddress"}},
				},
				{
					RpcMethod:      "SeenBtcChainTip",
					Use:            "seen-btc-chain-tip [height] [hash] [btc-oracle-address]",
					Short:          "Send a SeenBtcChainTip tx",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "height"}, {ProtoField: "hash"}, {ProtoField: "btcOracleAddress"}},
				},
			},
		},
	}
