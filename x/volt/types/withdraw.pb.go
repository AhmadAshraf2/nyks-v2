...
// source: twilightproject/nyks/volt/withdraw.proto
...
func (*BtcWithdrawRequestInternal) Descriptor() ([]byte, []int) {
	return fileDescriptor_649f8d1c0f060b0d, []int{0}
}
...
func (*ReserveWithdrawPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_649f8d1c0f060b0d, []int{1}
}
...
func (*WithdrawRequestSnap) Descriptor() ([]byte, []int) {
	return fileDescriptor_649f8d1c0f060b0d, []int{2}
}
...
func (*ReserveWithdrawSnapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_649f8d1c0f060b0d, []int{3}
}
...
func (*NewSweepProposalReceivedInternal) Descriptor() ([]byte, []int) {
	return fileDescriptor_649f8d1c0f060b0d, []int{4}
}
...
func init() {
	proto.RegisterFile("twilightproject/nyks/volt/withdraw.proto", fileDescriptor_649f8d1c0f060b0d)
}

var fileDescriptor_649f8d1c0f060b0d = []byte{
	// 545 bytes of a gzipped FileDescriptorProto
	,
}
