...
import (
	...
	"twilight-project/nyks/docs"
	bridgemodulekeeper "twilight-project/nyks/x/bridge/keeper"
	forksmodulekeeper "twilight-project/nyks/x/forks/keeper"
	nyksmodulekeeper "twilight-project/nyks/x/nyks/keeper"
	voltmodulekeeper "twilight-project/nyks/x/volt/keeper"
	zkosmodulekeeper "twilight-project/nyks/x/zkos/keeper"
)
...
func New(
	...
	// Register SendRestrictionFn on BankKeeper to track sats transfers
	// This replaces the old forked cosmos-sdk BankHooks pattern
	app.BankKeeper.AppendSendRestriction(func(ctx context.Context, fromAddr, toAddr sdk.AccAddress, amt sdk.Coins) (sdk.AccAddress, error) {
		err := app.VoltKeeper.TrackBeforeSend(ctx, fromAddr, toAddr, amt)
		if err != nil {
			return toAddr, err
		}
		return toAddr, nil
